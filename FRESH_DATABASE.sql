...
CREATE DATABASE `car` CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE `car`;
...
-- ========================================
-- TABLE 2: Vehicles
-- Frontend expects: id, name, model, plateNumber, dailyPrice, weeklyPrice, monthlyPrice, deposit, insuranceRequired, status, image
-- ========================================
...
-- ========================================
-- TABLE 3: Customers
-- Frontend expects: id, name, phone, email, idNumber, address, insurance, depositPaid, paymentMethod, outstandingBalance, rentalType
-- ========================================
...
-- ========================================
-- TABLE 4: Rentals
-- Frontend expects: id, customerId, vehicleId, startDate, endDate, rentalType, weeklyAmount, monthlyAmount, depositAmount, totalAmount, paidAmount, remainingAmount, nextPaymentDate, status, paymentStatus, agreementSigned, qrCode
-- ========================================
...
-- ========================================
-- TABLE 5: Documents
-- Frontend expects: id, customerId, rentalId, vehicleId, documentType, status, fileUri, uploadedDate, expiryDate
-- ========================================
...
-- Frontend expects: id, vehicleId, serviceDate, reason, description, expectedReturnDate, cost, status
-- ========================================
...
-- ========================================
-- TABLE 7: Payments
-- Frontend expects: id, rentalId, customerId, amount, date, method, status
-- ========================================
...
-- Sample Vehicles (matching frontend dummy data)
...
-- Sample Customers (matching frontend dummy data)
...
-- Sample Rentals (matching frontend dummy data)
...
-- Sample Documents (matching frontend dummy data)
...
-- Sample Maintenance Records (matching frontend dummy data)
...
-- Sample Payments (matching frontend dummy data)
...
-- ========================================
-- Tables Created: admins, vehicles, customers, rentals, documents, maintenance, payments, settings
-- Sample Data: 10 vehicles, 5 customers, 6 rentals, 5 documents, 3 maintenance records, 5 payments
